...
int main (int argc, char *argv[])
{
   ...
   //----------------------------------------------------------
    ...
    foreach(QString str, cmdLineArgs)
    {
		...
		else if (str.startsWith("-inmetsrv:", Qt::CaseInsensitive))					//HB
		{																			//HB
			str.remove("-inmetsrv:", Qt::CaseInsensitive);							//HB												
			Util::setSetting("inmetServerName",  str);								//HB Save server name from args
		}																			//HB
    }
//
